...
public class SettingsFirstSim extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveSettingsButton = (Button) findViewById(R.id.button_save_test_settings_first_sim);
        ...
        frequencyAlert.setText(firstSimSettings.get(ALERT_FREQUENCY));
        numbersAlerts.setText(firstSimSettings.get(ALERT_NUMBERS));
        email.setText(firstSimSettings.get(EMAILS));
        ...
        saveSettingsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firstSimSettings.put(ALERT_FREQUENCY, frequencyAlert.getText().toString());
                Log.d(TAG, firstSimSettings.get(ALERT_FREQUENCY));
                firstSimSettings.put(ALERT_NUMBERS, numbersAlerts.getText().toString());
                Log.d(TAG, firstSimSettings.get(ALERT_NUMBERS));
                firstSimSettings.put(EMAILS, email.getText().toString());
                Log.d(TAG, firstSimSettings.get(EMAILS));
