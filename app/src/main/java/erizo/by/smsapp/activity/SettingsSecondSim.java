...
public class SettingsSecondSim extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frequencyAlert.setText(secondSimSettings.get(ALERT_FREQUENCY));
        numbersAlerts.setText(secondSimSettings.get(ALERT_NUMBERS));
        email.setText(secondSimSettings.get(EMAILS));
        ...
        saveSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                secondSimSettings.put(ALERT_FREQUENCY, frequencyAlert.getText().toString());
                Log.d(TAG, secondSimSettings.get(ALERT_FREQUENCY));
                secondSimSettings.put(ALERT_NUMBERS, numbersAlerts.getText().toString());
                Log.d(TAG, secondSimSettings.get(ALERT_NUMBERS));
                secondSimSettings.put(EMAILS, email.getText().toString());
                Log.d(TAG, secondSimSettings.get(EMAILS));
